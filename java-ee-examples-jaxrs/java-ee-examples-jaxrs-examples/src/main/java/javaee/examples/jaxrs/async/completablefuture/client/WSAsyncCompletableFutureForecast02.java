/*
* Classname:    WSAsyncCompletableFutureForecast02.java
 ...
 * @author Héctor Hernández Chávez
 */
@Path("async-completable-future/forecast02")
public class WSAsyncCompletableFutureForecast02 {
